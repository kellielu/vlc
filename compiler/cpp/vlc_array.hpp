...
class VLC_Array {
	...
	public:
		...
		size_t  get_num_dimensions(); // Returns number of dimensions
		...
		VLC_Array<T>& operator=(VLC_Array<T> &vlcarray);
...
//Operator =
template <class T>
VLC_Array<T>& VLC_Array<T>::operator=(VLC_Array<T> &vlcarray){
	if(this == vlcarray){
		return *this;
	}
	/* For now, make a deep copy every time. Can optimize later */
	...
	values = malloc(sizeof(T) * vlcarray.total_elements());
	dimensions = malloc(sizeof(size_t) * vlcarray.get_num_dimensions());
...
template <class T>
size_t VLC_Array<T>::get_num_dimensions(){ return this->num_dimensions; }

template <class T>
size_t VLC_Array<T>::size(){ return this->dimensions[0]; }

template <class T>
size_t VLC_Array<T>::total_elements(){ return this->num_values; }
